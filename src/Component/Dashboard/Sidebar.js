...
import 
{BsCart3, BsGrid1X2Fill, BsFillArchiveFill} from 'react-icons/bs'
  ...
  return (
    ...
    <aside id="sidebar" className={openSidebarToggle ? "sidebar-responsive": ""}>
        ...
        <ul className='sidebar-list'>
            ...
            <li className='sidebar-list-item'>
                <Link to="/main/TechPack">
                    <BsFillArchiveFill className='icon'/> Bill of materials
                </Link>
            </li>
            <li className='sidebar-list-item'>
                <Link to="/main/TechPack">
                    <BsFillArchiveFill className='icon'/> Purchase Orders
                </Link>
            </li>
            <li className='sidebar-list-item'>
                <Link to="/main/TechPack">
