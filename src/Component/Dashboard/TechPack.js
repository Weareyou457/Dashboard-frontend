...
const TechPack = () => {
  ...
  const Filter = (event) => {
    setrecords(data.filter(f =>
      ...
      f.Style.includes(event.target.value)
    ))
  }
  ...
  return (
    <div className='hdbeb'>
      <div className='alfaiz'>
        <form >
          ...
          <div className="ui form">
            ...
            {
              messge !== " " && <div style={{display:"flex",justifyContent:"center",alignItems:"center",color:"white",fontSize:"20px"}}>{messge.message}</div>
            }
      ...
      <div className='marginn'>
        ...
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}><input type="text" className='form-control' onChange={Filter} placeholder='Search By Style' /></div>
